...
//        if(community.getIsPublic().equals(PublicType.privateType)){
//            sendPasswordEmail(user.getEmail(),community.getPassword(),community.getName());
//        }
//
//        return new CommunityCreateRes(communityId, "커뮤니티를 생성하였습니다.",community.getIsPublic().toString());
//    }
//    //커뮤니티 비밀번호
...
//                        .type(c.getType().toString())
//                        .category(c.getCategory().toString())
//                        .publicType(c.getIsPublic().toString())
//                        .build()
//        ).collect(Collectors.toList());
//
